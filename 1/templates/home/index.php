...
<form method="post" action="." class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 max-w-md">
    ...
    <div class="mb-4">
        <input
                class="shadow appearance-none border rounded w-full py-2 px-3 text-white bg-blue-600 leading-tight focus:outline-none focus:shadow-outline cursor-pointer"
